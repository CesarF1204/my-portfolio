/* ==========================================================================
    ...
    Vanilla JavaScript only (no jQuery), written in ES6.
...
(() => {
    ...
    class TypeWriter {
        ...
        type() {
            ...
            window.setTimeout(() => this.type(), speed);
        }
    }
...
/* ----------------------- Certificate carousel ------------------------ */
    ...
    const initCertificateCarousel = () => {
        ...
        const showThumbnailPage = (page) => {
            thumbnails.forEach((thumb, index) => {
                const start = page * thumbnailsPerPage;
        ...
        el.addEventListener("slid.bs.carousel", (event) => {
            ...
            if (event.to !== undefined) {
                const newPage = Math.floor(event.to / thumbnailsPerPage);
    ...
    const showTooltip = (target) => {
        ...
        showTooltip._hideTimer = window.setTimeout(() => {
    ...
    const initTooltips = () => {
        document.querySelectorAll("[data-original-title]").forEach((tile) => {
            tile.addEventListener("mouseenter", () => showTooltip(tile));
            tile.addEventListener("mouseleave", hideTooltip);
            tile.addEventListener("focusin", () => showTooltip(tile));
    ...
    const updateWorkYears = () => {
        // Calculate completed years since September 27, 2021
        const startDate = new Date(2021, 8, 27); // September 27, 2021
        const now = new Date();
        ...
        const el = document.getElementById("work-year");
